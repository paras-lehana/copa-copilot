...
- **E2E + a11y** — axe (WCAG 2.1 A/AA) on **all 10 routes in light AND dark**, plus persona journeys (fan dashboard → exit advice; assistant wheelchair route; organizer briefing; RTL switch) on desktop and mobile, asserting engine-derived behaviour, not just visibility.
