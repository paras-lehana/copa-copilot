...
export const GOOGLE_SERVICES: readonly GoogleService[] = [
  {
    ...
    family: 'Google AI',
    status: 'implemented',
    purpose: 'Function-calling stadium assistant, operations briefings and incident drafting.',
    codePaths: ['apps/api/src/services/gemini-client.ts', 'apps/api/src/services/assistant.ts', 'PROMPTS.md'],
    envVarNames: ['GEMINI_API_KEY', 'GEMINI_MODEL'],
  ...
  },
  {
    ...
    family: 'Security',
    status: 'implemented',
    purpose: 'Holds the Gemini key; mounted by reference with least-privilege IAM.',
